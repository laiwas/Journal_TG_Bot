...
# Daily Journal: структурирование дня
...
async def start(m: Message):
    ...
    await m.answer(
        ...
        "• Понимание задачи — пришли текст/голос с описанием задачи, сформирую карточку задачи.",
...
async def process_task(m: Message, raw_text: str):
    task_text = understand_task(raw_text)
...
async def handle_audio(m: Message):
    ...
    try:
        ...
        text = transcribe(wav_path)  # ру язык фиксирован в stt.py
